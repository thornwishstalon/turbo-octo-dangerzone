...
public class BM25LSimilarity extends Similarity {
	 ...
	 */
	public BM25LSimilarity(float k1,float k3, float b,float l) {
		this.k1 = k1;
		this.b  = b;
		this.k3 = k3;
		this.delta = l;
	...
	public final SimScorer simScorer(SimWeight stats, AtomicReaderContext context) throws IOException {
		...
		//stats.addDoclength(context.reader().);
	...
	private class BM25DocScorer extends SimScorer {
		...
		public float score(int doc, float freq) {
			...
			return weightValue * fD ;//* freq / (freq + norm);
		}
	...
	public String toString() {
		return "BM25L(k1=" + k1 + ",b=" + b + ",k3= "+k3+",l= "+delta+")";
	}
	...
	/**
	 * Returns the <code>k3</code> parameter 
	 * @see #BM25LSimilarity(float, float) 
	 */
	public float getK3() {
		return k3;
	}
	...
	/**
	 * Returns the <code>l</code> parameter 
	 * @see #BM25LSimilarity(float, float) 
	 */
