...
public enum DocParentFolderEnum {
	ALT_ATHEISM(1), 
	COMP_GRAPHICS(2),
	COMP_OS_MS_WINDOWS_MISC(3),
	COMP_SYS_IBM_PC_HARDWARE(4),
	COMP_SYS_MAC_HARDWARE(5),
	COMP_WINDOWS_X(6),
	MISC_FORSALE(7),
	REC_AUTOS(8),
	REC_MOTORCYCLES(9),
	REC_SPORT_BASEBALL(10),
	REC_SPORT_HOCKEY(11),
	SCI_CRYPT(12),
	SCI_ELECTRONICS(13),
	SCI_MED(14),
	SCI_SPACE(15),
	SOC_RELIGION_CHRISTIAN(16),
	TALK_POLITICS_GUNS(17),
	TALK_POLITICS_MIDEAST(18),
	TALK_POLITICS_MISC(19),
	TALK_RELIGION_MISC(20);
